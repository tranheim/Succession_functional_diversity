...
Code to reproduce panels in manuscript figure 6b

NB! Elements fig 6a and 6c are conceptual and not based on codes
...
p1 = d1 %>% 
  ...
  ggtern::ggtern(aes(D,R,Q, colour = Succession, shape = Succession)) +
        theme_bw()+
